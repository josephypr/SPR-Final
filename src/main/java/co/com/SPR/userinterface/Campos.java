...
public class Campos {
    ...
    public static final Target BTN_PERFIL_VERIFICAR = Target.the("boton perfil").located(By.xpath("//*[@id=\"root\"]/div/header/div/div/button[1]"));
    ...
    public static Target BTN_PORTAFOLIO = Target.the("boton portafolio").located(By.xpath("//*[@id=\"root\"]/div/main/aside/button"));

    public static Target BTN_ELiMINARPORTAFOLIO = Target.the("boton eliminar portafolio").located(By.xpath("//*[@id=\"root\"]/div/div/div/div/button"));
}
